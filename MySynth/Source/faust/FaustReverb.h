  ...
  public:
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		for (int i=0; i<count; i++) {
			...
			float fTemp29 = (fSlow89 * fRec44[1]);
			float fTemp30 = (0.37f * (fRec1[0] - fRec2[0]));
			float fTemp31 = (fSlow84 * fRec45[1]);
			fRec45[0] = (fTemp30 - (fTemp31 + (fSlow83 * fRec45[2])));
			float fTemp32 = (fTemp31 + fRec45[2]);
			float fTemp33 = (fSlow83 * fRec45[0]);
			float fTemp34 = (0.5f * ((fTemp33 + (fTemp30 + fTemp32)) + (fSlow80 * ((fTemp33 + fTemp32) - fTemp30))));
			fRec44[0] = (fTemp34 - (fTemp29 + (fSlow88 * fRec44[2])));
			float fTemp35 = ((fSlow88 * fRec44[0]) + (fTemp29 + fRec44[2]));
			output1[i] = (FAUSTFLOAT)(0.5f * (fRec43[0] * (fTemp28 + (fTemp27 * ((fSlow85 * (fTemp35 - fTemp34)) + (fTemp34 + fTemp35))))));
			// post processing
